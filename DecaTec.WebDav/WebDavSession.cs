...
namespace DecaTec.WebDav
{
    ...
    public class WebDavSession : IDisposable
    {
        ...
        {
            return await ListAsync(uri, propFind, WebDavDepthHeaderValue.One, uriKind);
        }

        public async Task<IList<WebDavSessionItem>> ListAsync(Uri uri, PropFind propFind, WebDavDepthHeaderValue depth, UriKind uriKind = UriKind.Absolute)
        {
            ...
            return await ListAsync(uri, requestContentString, depth, uriKind);
        }

        public async Task<IList<WebDavSessionItem>> ListAsync(Uri uri, string propFindXmlString, WebDavDepthHeaderValue depth, UriKind uriKind = UriKind.Absolute)
        {
